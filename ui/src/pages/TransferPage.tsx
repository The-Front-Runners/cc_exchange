...
export default function DexTransferPage() {
  ...
  return (
    <div className="bg-green-900 h-screen flex flex-col items-center justify-center">
      <h1 className="text-white text-xl font-bold mb-5">Decentralized Exchange</h1>
      <div className="bg-green-700 p-8 rounded-lg w-full sm:w-96 flex flex-col items-center">
        <div className="flex flex-col sm:flex-row items-center mb-8 w-full">
          <div className="flex flex-col sm:flex-row items-center sm:mr-4">
            <label htmlFor="fromToken" className="text-white mb-2 mr-2 sm:mr-4">From:</label>
            <select
              id="fromToken"
              value={fromToken}
          ...
          <div className="flex flex-col sm:flex-row items-center sm:ml-4">
            <label htmlFor="toToken" className="text-white mb-2 mr-2 sm:mr-4">To:</label>
            <select
              id="toToken"
              value={toToken}
        ...
        <div className="flex flex-col w-full mb-8">
          <label htmlFor="amount" className="text-white mb-2">Amount:</label>
          <input
            id="amount"
            type="text"
            placeholder="0.0"
